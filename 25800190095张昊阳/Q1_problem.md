...
**A.1.** Using a rotating reference frame centered on the system's center of mass, find the expression for the tension $T_N$ at the midpoint of the tether. Use a first-order Taylor expansion in terms of $L/r$ to simplify your result.Write the result in the form of an expression. **[1.2 pt]**
...
**A.3.** Determine the polarity of the induced EMF. Which satellite (the one closer to Earth or the one farther from Earth) accumulates positive charges? Choose:A:Closer; B:Farther  **[0.8 pt]**
...
**B.1.** Derive the expression for the total Lorentz force $\vec{F}_L$ acting on the tether. Indicate the direction of this force (Same as or Opposite to $\vec{v}$). **[1.0 pt]**
...
- **[Final Result]**:
  The total force:
   $\vec{F}_L \approx - I B(r) L \hat{v}$, Opposite
